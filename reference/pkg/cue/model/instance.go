...
import (
	...
	"k8s.io/klog/v2"
	sets2 "kdp-oam-operator/reference/pkg/cue/model/sets"
)
...
type Instance interface {
	...
	IsBase() bool
	Unify(other cue.Value, options ...sets2.UnifyOption) error
	Compile() ([]byte, error)
}
...
func (inst *instance) Unify(other cue.Value, options ...sets2.UnifyOption) error {
	pv, err := sets2.StrategyUnify(inst.v, other, options...)
	if err != nil {
		return err
	}
	inst.v = pv
