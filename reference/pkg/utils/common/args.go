...
import (
	"fmt"
	"kdp-oam-operator/reference/pkg/cue/packages"
	pkgmulticluster "kdp-oam-operator/reference/pkg/multicluster"
...
// GetSchema get schema, if not exist, will create
func (a *Args) GetSchema() (*runtime.Scheme, error) {
	if a.Schema != nil {
		return a.Schema, nil
	}
