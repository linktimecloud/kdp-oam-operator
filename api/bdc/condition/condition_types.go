...
const (
	ReasonReconcileVela    ConditionReason = "VelaApplicationGenerated"
...
// ReconcileVela returns a condition indicating that vela resource created
// created the most recent reconciliation of vela resource.
func ReconcileVela() Condition {
	return Condition{
		Type:               TypeSynced,
		Status:             corev1.ConditionTrue,
		LastTransitionTime: metav1.Now(),
		Reason:             ReasonReconcileVela,
	}
}
